...
public class DispositivoResource {
	...
	@GET
	@Path("tiposDispositivo")
	@Produces({ MediaType.APPLICATION_JSON } )
	public Response darTiposDispositivos() throws SQLException, Exception{
		RedetekApiTM tm = new RedetekApiTM(getPath());
		try {
			
			return Response.status( 200 ).entity( tm.darTiposDispositivoPor(0, "hola") ).build();	
		}catch( Exception e )
		{
			return Response.status( 500 ).entity( doErrorMessage( e ) ).build( );
		}
